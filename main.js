...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var Item = __webpack_require__(207);
	var Result = __webpack_require__(209);
	var NoMatch = __webpack_require__(210);

	ReactDOM.render(React.createElement(
	  Router,
	  { history: browserHistory },
	  React.createElement(Route, { path: "/", component: Index }),
	  React.createElement(Route, { path: "/item/:itemid", component: Item }),
	  React.createElement(Route, { path: "/result", component: Result }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var React = __webpack_require__(1);
	var Link = __webpack_require__(159).Link;
	var Arr = __webpack_require__(208);
	...
	var Item = React.createClass({
		...
		componentWillReceiveProps: function componentWillReceiveProps(nextpty) {
		...
		showanswer: function showanswer(arg) {
		...
		render: function render() {
			...
			if (this.state.isload) {
				...
				if (data.sinaimg != "") {
					pic = React.createElement('img', { src: sina + data.sinaimg });
				}

				if (data.Type == 1) {
					pdt = React.createElement(
						'ul',
						{ id: 'answerlist' },
						React.createElement(
							'li',
							{ onTouchEnd: this.showanswer },
							'对'
						),
						React.createElement(
							'li',
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'h3',
						{ id: 'ico' },
						React.createElement('i', { className: this.state.style })
					),
					React.createElement(
						'div',
						{ className: 'txt' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* 
	* @Author: willclass
	* @Date:   2016-02-24 13:00:01
	* @Last Modified by:   willclass
	* @Last Modified time: 2016-02-24 13:01:26
	*/
